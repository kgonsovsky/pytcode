...
select
      vost_uch_begin.relation_id as vost_uch_begin_slave_id, vost_uch_end.relation_id as vost_uch_end_slave_id,
       ...
       melk_set.relation_id as melk_set_slave_id
from source
...
left outer join melk_set on melk_set.num = source.num_cnsi_melk_set
;
...
create view resultView as
    select vost_uch_begin.name as name_begin_vost_uch, vost_uch_end.name as name_end_vost_uch,
           ...
           vost_pol.﻿id as ﻿id_uch_vost_pol, melk_set.num as num_cnsi_melk_set
    from result
...
left outer join melk_set on melk_set.relation_id = result.melk_set_slave_id
;
